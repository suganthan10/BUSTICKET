              ...
              <div class="card-body p-4 p-lg-5 text-black">
                 ...
                 <form method="post" action="{{ route('register.perform') }}">
                  ...
                  <div class="d-flex align-items-center mb-3 pb-1">
                    ...
                    <a href="{{ url('/') }}"> <img src="{{ url('assets/img/bus-online-ticket.png') }}" alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem;" /></a>
                  </div>
                  ...
                  <div class="form-outline mb-4">
                    <input type="password" class="form-control form-control-lg" name="password" id="password" value="{{ old('password') }}" placeholder="Password" required="required">
                  ...
                  <div class="form-outline mb-4">
                    <input type="password" class="form-control form-control-lg" name="password_confirmation" id="password_confirmation" value="{{ old('password_confirmation') }}" placeholder="Confirm Password" required="required">
